...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Tupac</b>Amaru II</span>
    </a>
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="#" class="btn btn-default btn-flat">Perfil Personal</a>
                </div>
                <div class="pull-right">
                  <a href="../controlador/usuario/controlador_cerrar_session.php" class="btn btn-default btn-flat">Cerrar session</a>
                </div>
              </li>
            </ul>
          </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2021 -2021 <a href="https://adminlte.io">TupacAmaruII</a>.</strong> Reservados todos los 
    derechos.
  </footer>
